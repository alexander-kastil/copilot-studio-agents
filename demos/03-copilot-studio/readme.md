# Building & Testing Agents with Microsoft Copilot Studio
...
It is split into four focused topics that move from first agent to advanced orchestration, then to the new UI and evaluating what you ship.
...
| 4 | [The New Copilot Studio Experience](./04-ui-update/readme.md) | The rebuilt UI taught beside the classic experience: the toggle and coexistence, the unified Build surface and new orchestrator, testing and evaluating agents on both surfaces, Agent Skills and `SKILL.md`, and tools, MCP, and the new Workflows designer |
