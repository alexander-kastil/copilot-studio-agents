...
- **Spending policies**: Usage-based billing is governed by spending policies with monthly limits, per-user limits, and alert thresholds, so a single user cannot drain the tenant's Copilot Credits. See [Module 1: Pay as you go licensing](../../01-intro/05-licensing-setup/readme.md#pay-as-you-go-licensing).

---

## Hands-On Demo

- [Turn a Partner Meeting into a Follow-Up Package](./demo-01-follow-up.md): watch the approval gate and risk levels in action as Cowork edits a proposal, emails an external partner, and books a follow-up call, each held for your go-ahead.
...
- **[Scheduling Prompts & Recurring Automation](../04-automation/readme.md)**: the same approval model applies to scheduled actions
