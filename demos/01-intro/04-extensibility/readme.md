...
1. [Licensing & Environment Setup](../05-licensing-setup/readme.md): enable and configure what your chosen path needs
2. [How Agents Work: Knowledge, Prompting, Tools & MCP](../03-agent-anatomy/readme.md): the parts you will assemble on any path
