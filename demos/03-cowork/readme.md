...
Cowork is Microsoft 365's agentic AI that does work on your behalf. You describe an outcome in plain language, Cowork plans and executes the steps across your apps, and you approve before anything is sent or saved. This module is split into four focused topics: start with the intro, then go deeper on skills, automation, and control.

## Topics

| # | Topic | What you learn |
|---|-------|----------------|
| 1 | [Intro to Cowork](./01-intro/readme.md) | What Cowork is, how it differs from Copilot Chat, where to access it, the interaction model, and its core capabilities |
| 2 | [Skills](./02-skills/readme.md) | Built-in skills and the side panel, plus authoring your own custom skills with a `SKILL.md` file |
| 3 | [Automation & Plugins](./03-automation/readme.md) | Running prompts on a recurring schedule and extending Cowork with plugins from the Microsoft 365 App Store |
| 4 | [Staying in Control](./04-staying-in-control/readme.md) | The approval model, risk levels, pause and resume, feedback, and how admins govern Cowork |
