# Lab 02: Build Your First Copilot Studio Agent
...
To create a new agent, open a browser and, using the work account of your target Microsoft 365 tenant, go to [https://copilotstudio.microsoft.com](https://copilotstudio.microsoft.com) to start using Microsoft Copilot Studio.

Select **Create an agent** command in the middle of the screen, like illustrated in the following screenshot.

![The home page of Microsoft Copilot Studio with the **Create an agent** command highlighted to create a new agent.](./_images/make-agent-01a.png)
...
![The "Agents" page of Microsoft Copilot Studio with the **Create blank agent** command highlighted to create a new agent.](./_images/make-agent-01b.png)
...
![The home page of a new agent in Microsoft Copilot Studio with all the options to define Name, Icon, Description, Model selection, Triggers, Instructions, etc..](./_images/make-agent-03a.png)
...
![The section to edit "Name" and "Description" for the newly created agent.](./_images/make-agent-04a.png)
...
![The section to edit the "Instructions" for the newly created agent.](./_images/make-agent-05a.png)

Scroll down to the **Knowledge** section and select the **+ Add knowledge** command to add an initial data source for your agent.

![The dialog to add knowledge to the agent with the "Public website" option highlighted.](./_images/make-agent-06a.png)
...
![The dialog to add knowledge to the agent with the "Add" command highlighted.](./_images/make-agent-07a.png)
...
![The dialog to add knowledge to the agent with the "Add to agent" command highlighted.](./_images/make-agent-08a.png)

> **Important:** In this sample agent, we are going to use some of the public content available on the Careers website of Microsoft as the data source. Feel free to use any other public website of your choice, as long as it covers content related to HR and careers.
...
> **Tip:** To learn more about creating agents with Microsoft Copilot Studio, you can refer to [Agent Academy - Recruit - Mission 06: Create a custom agent using natural language with AI and grounding it with your data](https://microsoft.github.io/agent-academy/recruit/06-create-agent-from-conversation/).
...
![The **Details** panel of the agent in edit mode, where it is possible to update the Name, the icon, the description, and the instructions for the agent.](./_images/make-agent-04a.png)

Select the **Change icon** button to show a dialog from where you can upload a custom icon. If you like, you can use the [following icon](https://raw.githubusercontent.com/microsoft/copilot-camp/refs/heads/main/src/make/copilot-studio/HR-agent-color.png).

![The **Details** panel of the agent in edit mode, where it is possible to update the Name, the icon, the description, and the instructions for the agent.](./_images/make-agent-change-icon-07.png)
...
![The **Test** panel with the interaction between the user, asking for 'What is our mission?', and the agent providing a response based on the actua content available on the data source, with direct references to the pages on the data source website.](./_images/make-agent-test-08.png)
...
![The **Overview** tab of the agent with the **+ Add knowledge** button highlighted.](./_images/make-agent-spo-knowledge-01.png)
...
![The dialog to configure additional knowledge for the agent. Options are public websites, SharePoint, Dataverse, or other advanced data sources.](./_images/make-agent-spo-knowledge-02.png)
...
![The dialog to add a SharePoint data source. There is a **Browse files** button to search for specific files, a textbox to provide the URL of a site, and an **Add** button.](./_images/make-agent-spo-knowledge-03.png)
...
![The dialog to add a SharePoint data source. There is a datasource selected with proper name and description.](./_images/make-agent-spo-knowledge-04.png)
...
![The **Knowledge** section of the **Overview** page with two data sources: the website and the SharePoint Online site.](./_images/make-agent-spo-knowledge-05.png)
...
![The test panel with a conversation with the agent and a set of references to documents retrieved from the SharePoint Online knowledge base.](./_images/make-agent-spo-knowledge-06.png)
...
![The agent refusing to cover topics not defined in its list of instructions or knowledge bases.](./_images/make-agent-spo-knowledge-07.png)
...
![The button to publish an agent highlighted in the user interface of the agent editor.](./_images/make-agent-publish-01.png)
...
![The **Channels** tab where you can make an agent available in one or more channels. There is a list of available channels like "Telephony", "Teams + Microsoft 365", "Demo website", "Custom website", etc.](./_images/make-agent-publish-02.png)
...
![The side panel to enable the Microsoft Teams channel. There is a description of the current state and a button to **Add channel**.](./_images/make-agent-publish-03.png)
...
![The side panel to enable the Microsoft Teams channel. There is a description of the current state and a couple of buttons to **Turn on Teams** and to **Cancel**.](./_images/make-agent-publish-04.png)
...
![The side panel to see the availability options for the agent in Microsoft Teams. There are buttons to copy a link to the agent in Teams, to make the agent available in the Teams app store, and to download a zip with the agent package for sharing the agent on other tenants.](./_images/make-agent-publish-05.png)

Publishing of the agent in Microsoft Temas is now completed.

> **Tip:** To learn more about publishing Microsoft Copilot Studio agents, you can refer to [Agent Academy - Recruit - Mission 11: Publish Your Agent](https://microsoft.github.io/agent-academy/recruit/11-publish-your-agent/).
...
![The dialog window showing the agent as a new app in Microsoft Teams. There is an extended description of the app and of the agent. There is also a button to **Add** the app to Microsoft Teams.](./_images/make-agent-test-teams-01.png)
...
![The dialog window showing the agent as a new app in Microsoft Teams. There is an extended description of the app and of the agent. There is also a button to **Add** the app to Microsoft Teams.](./_images/make-agent-test-teams-02.png)
...
![The dialog window showing the agent as a new app in Microsoft Teams. There is an extended description of the app and of the agent. There is also a button to **Add** the app to Microsoft Teams.](./_images/make-agent-test-teams-03.png)
...
Continue with [Lab 03: Define Topics and Adaptive Cards](lab-03-topics.md).
