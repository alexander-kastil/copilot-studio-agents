...
Next, wire an external system into the same agent in [Connect an MCP Server and Publish a Workflow](../../../../demos/03-copilot-studio/04-ui-update/04-workflows-and-mcp/demo-04-connect-mcp-and-workflow.md).
