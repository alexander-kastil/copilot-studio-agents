...
Next, take the reasoning skills further in [Trace an Agent's Reasoning in the New Orchestrator](../../../demos/03-copilot-studio/04-ui-update/demo-02-trace-agent-reasoning.md).
