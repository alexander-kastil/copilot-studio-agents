...
- The new experience turned on, and one new-type agent already built. If you do not have one, run [Build and Ground Your First New-Experience Agent](../../demos/04-copilot-studio/demo-01-build-and-ground-an-agent.md) first and keep that Sales Assistant agent open.
...
Next, wire an external system into the same agent in [Connect an MCP Server and Publish a Workflow](../../demos/04-copilot-studio/demo-04-connect-mcp-and-workflow.md).
